<%-- 
    Document   : i_changepasswd
    Created on : Apr 11, 2019, 10:42:33 AM
    Author     : test
--%>
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html"><img src="assets/img/logo.png" alt="OCP Logo" class="img-responsive logo"></a>
			</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<% 
                                        ...
                                        <% }
                                         else if(msg.equals("omismatch")){
                                    %>     <%@ include file = "omismatchalert.jsp" %>
                                                        <%
}
                                         else if(msg.equals("cmismatch")){
                                    %>     <%@ include file = "cmismatchalert.jsp" %>
                                                        <%
}
}
catch(Exception e){
							...
							<div class="panel">
								...
								<div class="panel-body">
                                                                   <form action="i_changepasswdaction.jsp" method="POST"><%
      //  String s_id=request.getParameter("s_id");
       ...
       // rs.next();
        %>
									...
									<br><input type="hidden" name="i_id" value="<%out.print(i_id);%>">
