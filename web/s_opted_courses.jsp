          ...
          ResultSet rs6=DAL.DBConnect.SelectData("SELECT * FROM `course_opted` INNER JOIN course on course_opted.c_id=course.c_id where course.c_id="+rs5.getString("c_id")+" and course_opted.s_id="+rs5.getString("s_id"));
           ...
           <tr>
            ...
            <!--   <td><%//out.print(rs1.getString("i_name"));%></td> -->
               ...
               <%   if((rs6.getString("status")).equals("Approved")) {%>
                  <td><a href="download.jsp?f=C:\Files\<% out.print(rs6.getString("c_id"));%><%out.print(rs6.getString("datafile"));%>" class="btn btn-danger">Download</a></td> 
                  <td><a href="s_addReview.jsp?c_id=<% out.print(rs6.getString("c_id"));%>" class="btn btn-primary">Review</a></td> 
              <% }
%>    
