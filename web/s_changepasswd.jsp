<%-- 
    Document   : s_changepasswd
    Created on : Apr 10, 2019, 9:36:23 AM
    Author     : test
--%>
						...
						<div class="col-md-6">
							...
							<div class="panel">
								...
								<div class="panel-body">
                                                                   <form action="s_changepasswdaction.jsp" method="POST"><%
      //  String s_id=request.getParameter("s_id");
       ...
       // rs.next();
        %>
									...
									<br><input type="hidden" name="s_id" value="<%out.print(s_id);%>">
