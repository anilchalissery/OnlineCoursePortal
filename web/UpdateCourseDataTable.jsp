		...
		<div class="main">
         ...
         //  ResultSet rs1=DAL.DBConnect.SelectData("SELECT * FROM course INNER JOIN instructor on course.i_id=instructor.i_id");
           ...
           %>
                ...
                <br>
                <select name="i_id" class="form-control"><%ResultSet rs5=DBConnect.SelectData("SELECT * FROM `instructor`");
                                                                            while(rs5.next()){%>
                            <option value="<%out.print(rs5.getString("i_id"));%>"><%out.print(rs5.getString("i_name"));%></option>
                <% }  %>        </select>
