...
<head>
	<title>Update Department table | Online Course Portal</title>
        <%
	...
	<div id="wrapper">
		...
		<div class="main">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel">
								...
								<div class="panel-body"> <% String dept_id=request.getParameter("dept_id");
            ResultSet rs=DBConnect.SelectData("SELECT * FROM `department` WHERE dept_id="+dept_id); 
									...
									<input type="text" class="form-control" placeholder="Department name" name="dept_name" value="<%out.print(rs.getString("dept_name"));%>">
									<br><input type="hidden" value="<%out.print(rs.getString("dept_id"));%>" name="dept_id">
