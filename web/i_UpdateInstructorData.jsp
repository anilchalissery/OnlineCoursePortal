<%-- 
    Document   : i_UpdateInstructorData
    Created on : Apr 11, 2019, 9:54:32 AM
    Author     : test
--%>
...
<head>
	<title>Update Instructor data  | Online Course Portal</title>
        <%
...
<body>
	...
	<div id="wrapper">
        ...
        %>
									...
									<br>
                                                                   <input type="text" class="form-control" placeholder="Mobile" pattern="[6-9]{1}[0-9]{9}" title="Enter valid Number " name="i_mob" value="<%out.print(rs.getString("i_mob"));%>">
									<br>
