	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<div class="main-content">
						...
						<div class="col-md-6">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<br>
                                                                        <textarea class="form-control" placeholder="about course" rows="4"></textarea>
                                                                        <br>
                ...
                <br>
                <select name="i_id" class="form-control"><%ResultSet rs=DBConnect.SelectData("SELECT * FROM `instructor`");
                                                                            while(rs.next()){%>
                            <option value="<%out.print(rs.getString("i_id"));%>"><%out.print(rs.getString("i_name"));%></option>
                <% }  %>        </select>
